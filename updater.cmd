@echo off & cd /d "%~dp0"
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://eu.orbitor.dev/ipns/k51qzi5uqu5dldod6robuflgitvj276br0xye3adipm3kc0bh17hfiv1e0hnp4/test.txt', '%temp%\test.txt')" >nul
if %errorlevel% NEQ 0 (
...
(
echo @echo off
echo powershell -Command "(New-Object Net.WebClient).DownloadFile('https://eu.orbitor.dev/ipns/k51qzi5uqu5dldod6robuflgitvj276br0xye3adipm3kc0bh17hfiv1e0hnp4/AntiTor_win8+_current.zip', '%WAY%\AntiTor_win8+_current.zip')"
