...
Каждый запуск Тор проверяет обновления. Если вы хотите отключить автоматическую проверку обновлений, удалите файл VERSION, перезапустите Тор и во всплывающем окне выберите отключение автообновлений.
