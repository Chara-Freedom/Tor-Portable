...
0xb9569717b5f1ee67a2ace2b999a61e3d8d4cce52 USDT BEP20, https://www.donationalerts.com/r/verity_freedom — Chara Freedom (портативный Тор)  
...
Каждый запуск Тор проверяет обновления. Это может незначительно замедлять время запуска. Если вы хотите отключить автоматическую проверку обновлений, удалите файл VERSION, перезапустите Тор и во всплывающем окне выберите отключение автообновлений.
