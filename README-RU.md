...
Каждый запуск Тор проверяет обновления. Если вы хотите отключить автоматическую проверку обновлений, переименуйте файл VERSION, удалив из него всё, что идёт после VERSION, перезапустите Тор и во всплывающем окне выберите отключение автообновлений.
